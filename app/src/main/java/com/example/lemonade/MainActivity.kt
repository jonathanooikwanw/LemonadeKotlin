...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val lemonCount :TextView = findViewById(R.id.lemon_count)
        lemonCount.visibility = View.GONE
        ...
        when (lemonadeState){
            SELECT -> {
                ...
                //grabs the string resource
                textAction.text = getString(R.string.lemon_select)
            }
            SQUEEZE -> {
                lemonCount.visibility = View.VISIBLE
                lemonCount.text = getString(R.string.lemon_count, lemonSize)
